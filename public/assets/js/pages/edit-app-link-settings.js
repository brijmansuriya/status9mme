...
/*!******************************************************!*\
  !*** ./resources/js/pages/edit-app-link-settings.js ***!
  \******************************************************/
window.updateAppSettings = function (updateUrl, app_name, app_label, app_version, updates) {
  ...
  document.getElementById("updateAppVersion").setAttribute("value", app_version);
