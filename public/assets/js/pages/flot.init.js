...
!function ($) {
  ...
  FlotChart.prototype.init = function () {
    ...
    var pcolors = ['#4fc6e1', '#6658dd'];
    var borderColor = '#f5f5f5';
    var bgColor = '#fff';
    this.createPlotGraph("#website-stats", uploads, downloads, plabels, pcolors, borderColor, bgColor); //plot graph Dot data
    ...
    var pcolorsDot = ['#6658dd', '#f1556c'];
    var borderColorDot = '#f5f5f5';
    var bgColorDot = '#fff';
    this.createPlotDotGraph("#website-stats1", uploadsDot, downloadsDot, plabelsDot, pcolorsDot, borderColorDot, bgColorDot); //Pie graph data
    ...
    var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#4a81d4']);
    plot.draw();
    var $this = this;
    ...
    var donutcolors = ['#4a81d4', '#f672a7', '#f7b84b', '#4fc6e1', "#1abc9c"];
    this.createDonutGraph("#donut-chart #donut-chart-container", donutlabels, donutdatas, donutcolors); //Combine graph data
    ...
    this.createCombineGraph("#combine-chart #combine-chart-container", ticks, combinelabels, combinedatas); //bar chart = stacked
    ...
    this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#4fc6e1', '#f7b84b', '#4a81d4'], ds); //creating line chart
    ...
    this.createLineGraph("#line-chart-alt", line_ticks, ['#6c757d', '#f1556c'], line_data);
  }, //init flotchart
