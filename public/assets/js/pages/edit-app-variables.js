...
/*!**************************************************!*\
  !*** ./resources/js/pages/edit-app-variables.js ***!
  \**************************************************/
window.updateAppVariablesSettings = function (updateUrl, name, key, value) {
  ...
  document.getElementById("updateValue").setAttribute("value", value); // document.getElementById("updateKey").setAttribute("value", key);
