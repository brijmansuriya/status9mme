...
!(function (t, e) {
    ...
    (i.prototype.axisX = function (t, e, i) {
        t.attr("transform", function (t) {
            return "translate(" + Math.ceil(e(t) + i) + ", 0)";
        });
    }),
        (i.prototype.axisY = function (t, e) {
            t.attr("transform", function (t) {
                return "translate(0," + Math.ceil(e(t)) + ")";
            });
        }),
        (i.prototype.scaleExtent = function (t) {
            var e = t[0],
                i = t[t.length - 1];
            return e < i ? [e, i] : [i, e];
        }),
        (i.prototype.generateTicks = function (t) {
            var e,
                i,
                n = [];
            ...
            return (
                0 < n.length && 0 < n[0] && n.unshift(n[0] - (n[1] - n[0])), n
            );
        }),
        (i.prototype.copyScale = function () {
            var t,
                e = this.scale.copy();
            return (
        ...
        (i.prototype.textFormatted = function (t) {
            var e = this.tickFormat ? this.tickFormat(t) : t;
            return void 0 !== e ? e : "";
        }),
        (i.prototype.updateRange = function () {
            var t = this;
            return (
        ...
        (i.prototype.updateTickTextCharSize = function (t) {
            var a = this;
        ...
        (i.prototype.isVertical = function () {
            return "left" === this.orient || "right" === this.orient;
        }),
        (i.prototype.tspanData = function (t, e, i) {
            var n = this,
        ...
        (i.prototype.splitTickText = function (t, e) {
            var r,
                a,
                o,
                s = this,
        ...
        (i.prototype.ellipsify = function (t, e) {
            if (t.length <= e) return t;
            for (var i = t.slice(0, e), n = 3, r = e - 1; 0 <= r; r--) {
                var a = i[r].length;
                if (
                    ((i[r] = i[r].substr(0, a - n).padEnd(a, ".")),
                    (n -= a) <= 0)
                )
                    break;
            }
        ...
        (i.prototype.updateTickLength = function () {
            this.tickLength =
                Math.max(this.innerTickSize, 0) + this.tickPadding;
        }),
        (i.prototype.lineY2 = function (t) {
            var e = this,
                i = e.scale(t) + (e.tickCentered ? 0 : e.tickOffset);
            return e.range[0] < i && i < e.range[1] ? e.innerTickSize : 0;
        }),
        (i.prototype.textY = function () {
            var t = this.tickTextRotate;
            return t
                ? 11.5 - (t / 15) * 2.5 * (0 < t ? 1 : -1)
                : this.tickLength;
        }),
        (i.prototype.textTransform = function () {
            var t = this.tickTextRotate;
            return t ? "rotate(" + t + ")" : "";
        }),
        (i.prototype.textTextAnchor = function () {
            var t = this.tickTextRotate;
            return t ? (0 < t ? "start" : "end") : "middle";
        }),
        (i.prototype.tspanDx = function () {
            var t = this.tickTextRotate;
            return t ? 8 * Math.sin(Math.PI * (t / 180)) : 0;
        }),
        (i.prototype.tspanDy = function (t, e) {
        ...
        (i.prototype.generateAxis = function () {
            var w = this,
                v = w.d3,
                b = w.params;
            function T(t, m) {
    ...
    (d.prototype.init = function () {
        ...
        (d.prototype.updateXAxisTickValues = function (t, e) {
            ...
            return (
                ...
                e
                    ? e.tickValues(i)
                    : (n.xAxis.tickValues(i), n.subXAxis.tickValues(i)),
                i
            );
        }),
        (d.prototype.getYAxis = function (t, e, i, n, r, a, o) {
            var s = this.owner,
                ...
                l = new this.internal(this, d).axis
                    .scale(t)
                    .orient(e)
                    .tickFormat(i);
            return (
                ...
                i.axis_x_tick_format &&
                    (h(i.axis_x_tick_format)
                        ...
                        : e.isTimeSeries() &&
                          (n = function (t) {
                              return t
                                  ? e.axisTimeFormat(i.axis_x_tick_format)(t)
                                  : "";
                          })),
                h(n)
                    ? function (t) {
        ...
        (d.prototype.dyForXAxisLabel = function () {
            ...
            return e.axis_rotated
                ? i.isInner
                    ? "1.2em"
                    : -25 -
                      (t.config.axis_x_inner ? 0 : this.getMaxTickWidth("x"))
                : i.isInner
                ? "-0.5em"
                : e.axis_x_height
                ? e.axis_x_height - 10
        ...
        (d.prototype.dyForYAxisLabel = function () {
            ...
            return t.config.axis_rotated
                ...
                ? "1.2em"
                : -10 -
                  (t.config.axis_y_inner ? 0 : this.getMaxTickWidth("y") + 10);
        }),
        (d.prototype.dyForY2AxisLabel = function () {
            ...
            return t.config.axis_rotated
                ...
                ? "-0.5em"
                : 15 +
                  (t.config.axis_y2_inner
                      ? 0
                      : this.getMaxTickWidth("y2") + 15);
        }),
            ...
            return (
                (e && o.currentMaxTickWidths[t]) ||
                    ...
                    (o.currentMaxTickWidths[t] =
                        c <= 0 ? o.currentMaxTickWidths[t] : c)),
                o.currentMaxTickWidths[t]
            );
        }),
    ...
    var t = {
        ...
        chart: {
            ...
            internal: {
                fn: l.prototype,
                axis: { fn: d.prototype, internal: { fn: i.prototype } },
            },
        },
        generate: function (t) {
            return new n(t);
    ...
    return (
        ...
        (l.prototype.init = function () {
            ...
            if ((t.initParams(), e.data_url))
                ...
                t.initWithData(t.convertRowsToData(e.data_rows));
            else {
                if (!e.data_columns)
        ...
        (l.prototype.initParams = function () {
            ...
            (t.clipId = "c3-" + +new Date() + "-clip"),
                ...
                (t.dataTimeParse = (
                    i.data_xLocaltime ? e.timeParse : e.utcParse
                ...
                (t.rotated_padding_right =
                    i.axis_rotated && !i.axis_x_show ? 0 : 30),
        ...
        (l.prototype.initWithData = function (t) {
            ...
            (n.axis = new d(n)),
                ...
                n.config.svg_classname &&
                    n.svg.attr("class", n.config.svg_classname),
                (e = n.svg.append("defs")),
                ...
                (i = n.main =
                    n.svg
                        .append("g")
                        .attr("transform", n.getTranslate("main"))),
                n.initPie && n.initPie(),
                ...
                a.axis_x_selection &&
                    n.brush.selectionAsValue(n.getDefaultSelection()),
                o &&
                    (n.updateDimension(),
        ...
        (l.prototype.updateSizes = function () {
            ...
            (t.currentWidth = t.getCurrentWidth()),
                ...
                (t.margin = e.axis_rotated
                    ? {
                          top:
                              t.getHorizontalAxisHeight("y2") +
                              t.getCurrentPaddingTop(),
            ...
            if (
                ...
                H.length
                    ? (O.updateXDomain(H, c, d, l),
                      D.axis_x_tick_values ||
                          (C = O.axis.updateXAxisTickValues(H)))
        ...
        (l.prototype.getTranslate = function (t) {
            ...
            return (
                "main" === t
                    ...
                    : "y2" === t
                    ? ((e = r.axis_rotated ? 0 : n.width),
                      (i = r.axis_rotated ? 1 : 0))
                    : "subx" === t
        ...
        (l.prototype.transformMain = function (t, e) {
            ...
            e && e.axisX
                ? (i = e.axisX)
                : ((i = a.main.select("." + Y.axisX)),
                  t && (i = i.transition())),
                e && e.axisY
                    ? (n = e.axisY)
                    : ((n = a.main.select("." + Y.axisY)),
                      t && (n = n.transition())),
                e && e.axisY2
                    ? (r = e.axisY2)
                    : ((r = a.main.select("." + Y.axisY2)),
                      t && (r = r.transition())),
        ...
        (l.prototype.bindResize = function () {
            ...
            if (
                ...
                e.resize_auto &&
                    t.resizeFunction.add(function () {
                        void 0 !== t.resizeTimeout &&
                            window.clearTimeout(t.resizeTimeout),
                ...
                i
                    ? (i.add && i.remove) ||
                      (i = t.generateResize()).add(window.onresize)
                    : (i = t.generateResize()),
            ...
            return (
                ...
                (e && !isNaN(+e)) ||
                    window.console.error(
                        "Failed to parse x '" + t + "' to Date object"
                    ),
                e
            );
        }),
        ...
        "SVGPathSegList" in window ||
            ...
            (window.SVGPathSegList.prototype.replaceItem = function (t, e) {
                return (
                    ...
                    ((this._list[e] = t)._owningPathSegList =
                        this)._writeListToPath(),
                    t
                );
            }),
                    ...
                    (i.prototype._parseNumber = function () {
                        ...
                        if (
                            ...
                            if (this._currentIndex != s)
                                for (
                                    var c = this._currentIndex - 1, d = 1;
                                    s <= c;

                                )
                                    (e += d * (this._string.charAt(c--) - "0")),
                                        (d *= 10);
                            if (
                                this._currentIndex < this._endIndex &&
                                "." == this._string.charAt(this._currentIndex)
                            ...
                            if (
                                ...
                                "m" !=
                                    this._string.charAt(this._currentIndex + 1)
                            ) {
                                if (
                                    (this._currentIndex++,
                                    "+" ==
                    ...
                    (i.prototype.parseSegment = function () {
                        ...
                        switch ((this._previousCommand = e)) {
                            ...
                            case window.SVGPathSeg.PATHSEG_CLOSEPATH:
                                return (
                                    this._skipOptionalSpaces(),
                                    new window.SVGPathSegClosePath(n)
                                );
        ...
        (n.prototype.categorie = function (t, e) {
            var i = this.internal,
                n = i.config;
            return (
                1 < arguments.length &&
                    ((n.axis_x_categories[t] = e), i.redraw()),
        ...
        (n.prototype.destroy = function () {
            ...
            if (
                ...
                void 0 !== e.resizeTimeout &&
                    window.clearTimeout(e.resizeTimeout),
                window.detachEvent)
            )
                        ...
                        if (t.id === r[e].id) {
                            for (
                                ...
                                (r[e].values[i].index = h + i),
                                    c.isTimeSeries() ||
                                        (r[e].values[i].x = h + i);
                            (t.values = t.values.concat(r[e].values)),
                                r.splice(e, 1);
                            break;
                        }
                    n || d.push(t.id);
        ...
        (n.prototype.focus = function (e) {
            ...
            (e = i.mapToTargetIds(e)),
                (t = i.svg.selectAll(
                    i.selectorTargets(e.filter(i.isTargetToShow, i))
                )),
                this.revert(),
                this.defocus(),
                ...
                (i.defocusedTargetIds = i.defocusedTargetIds.filter(function (
                    t
                ) {
        ...
        ((n.prototype.xgrids = function (t) {
            var e = this.internal,
                i = e.config;
            return (
                t && ((i.grid_x_lines = t), e.redrawWithoutRescale()),
                i.grid_x_lines
            );
        }).add = function (t) {
            var e = this.internal;
        ...
        ((n.prototype.ygrids = function (t) {
            var e = this.internal,
                i = e.config;
            return (
                t && ((i.grid_y_lines = t), e.redrawWithoutRescale()),
                i.grid_y_lines
            );
        }).add = function (t) {
            var e = this.internal;
        ...
        (n.prototype.load = function (e) {
            ...
            e.xs && t.addXs(e.xs),
                ...
                "cacheIds" in e && t.hasCaches(e.cacheIds)
                    ...
                    ? t.unload(
                          t.mapToTargetIds(
                              "boolean" == typeof e.unload && e.unload
                                  ? null
                                  : e.unload
                          ),
                          function () {
        ...
        ((n.prototype.tooltip = function () {}).show = function (e) {
            ...
            (r = e.mouse
                ...
                : (e.data
                      ...
                      : void 0 !== e.x &&
                        ((t = e.id
                            ? n.data.targets.filter(function (t) {
                                  return t.id === e.id;
                              })
                            : n.data.targets),
                        (i = n.filterByX(t, e.x).slice(0, 1)[0])),
                  i ? n.getMousePosition(i) : null)),
                n.dispatchEvent("mousemove", r),
        ...
        (n.prototype.zoom.range = function (t) {
            ...
            k(t.max) && this.domain.max(t.max),
                k(t.min) && this.domain.min(t.min);
        }),
        ...
        (l.prototype.updateAngle = function (e) {
            ...
            return o
                ? (a
                      .pie(a.filterTargetsToShow(a.data.targets))
                      .forEach(function (t) {
                          s ||
                              t.data.id !== e.data.id ||
                              ((s = !0), ((e = t).index = c)),
        ...
        (l.prototype.getSvgArc = function () {
            var n = this,
                ...
                i =
                    n.gaugeArcWidth /
                    n.filterTargetsToShow(n.data.targets).length,
                r = n.d3
                    .arc()
        ...
        (l.prototype.getSvgArcExpanded = function (e) {
            ...
            var i = this,
                ...
                r =
                    i.gaugeArcWidth /
                    i.filterTargetsToShow(i.data.targets).length,
                a = Math.min(
                    i.radiusExpanded * e - i.radius,
                    0.8 * r - 100 * (1 - e)
                ),
                o = i.d3
                    .arc()
        ...
        (l.prototype.transformForArcLabel = function (t) {
            ...
            if (c && !l)
                ...
                c &&
                l &&
                1 < o.filterTargetsToShow(o.data.targets).length
            ) {
                var u = Math.sin(c.endAngle - Math.PI / 2);
                d =
                    "translate(" +
                    (i =
                        Math.cos(c.endAngle - Math.PI / 2) *
                        (o.radiusExpanded + 25)) +
                    "," +
        ...
        (l.prototype.getArcRatio = function (t) {
            var e = this.config,
                i =
                    Math.PI *
                    (this.hasType("gauge") && !e.gauge_fullCircle ? 1 : 2);
            ...
            i.transiting
                ? (e = window.setInterval(function () {
                      i.transiting ||
                          ...
                          0 <
                              i.legend
                                  .selectAll(".c3-legend-item-focused")
                                  .size() && i.expandArc(t));
                  }, 10))
            ...
            if (
                ((r = (n = c
                    ...
                    .style("cursor", function (t) {
                        return s.interaction_enabled &&
                            s.data_selection_isselectable(t)
                            ? "pointer"
                            : null;
                    })
                    .each(function (t) {
                        ...
                        : o
                              ...
                              .each(function (t) {
                                  var e = 0,
                                      ...
                                      r = "";
                                  if (
                                      l.hiddenTargetIds.indexOf(t.data.id) < 0
                                  ) {
                                      var a = l.updateAngle(t),
                                          o =
                                              (l.gaugeArcWidth /
                                                  l.filterTargetsToShow(
                                                      l.data.targets
                                                  ).length) *
                                              (a.index + 1),
                        ...
                        s.interaction_enabled
                            ? function (t) {
                                  var e,
                                      i = l.updateAngle(t);
                                  i &&
                                      ((e = [l.convertToArcData(i)]),
                                      l.showTooltip(e, this));
                              }
                            : null
                    )
                    .on(
                        ...
                        s.interaction_enabled
                            ? function (t, e) {
                                  ...
                                  n &&
                                      ...
                                      l.toggleShape &&
                                          l.toggleShape(this, i, e),
                                      l.config.data_onclick.call(
                                          l.api,
                                          i,
                                          this
                                      ));
                ...
                c
                    ...
                    .style("opacity", function (t) {
                        return l.isTargetToShow(t.data.id) &&
                            l.isArcType(t.data)
                            ? 1
                            : 0;
                    }),
                ...
                g
                    ...
                    .merge(g)
                    .attr("d", function (t) {
                        if (0 <= l.hiddenTargetIds.indexOf(t.id))
                            return "M 0 0";
                        var e = {
                            ...
                            endAngle:
                                -1 *
                                s.gauge_startingAngle *
                                (s.gauge_fullCircle ? Math.PI : 1),
                            index: h++,
                        };
                    ...
                    l.arcs
                        ...
                        .attr(
                            ...
                            -1 *
                                (l.innerRadius +
                                    (l.radius - l.innerRadius) /
                                        (s.gauge_fullCircle ? 1 : 2)) +
                                "px"
                        )
                        .attr("dy", "1.2em")
                        .text(
                            s.gauge_label_show
                                ? l.textForGaugeMinMax(s.gauge_min, !1)
                                : ""
                        ),
                    l.arcs
                        ...
                        .text(
                            s.gauge_label_show
                                ? l.textForGaugeMinMax(s.gauge_max, !0)
                                : ""
                        );
            }
        }),
        ...
        (l.prototype.classArc = function (t) {
            return (
                this.classShape(t.data) + this.generateClass(Y.arc, t.data.id)
            );
        }),
        (l.prototype.classArcs = function (t) {
            return (
                this.classShapes(t.data) + this.generateClass(Y.arcs, t.data.id)
            );
        }),
        ...
        (l.prototype.classTarget = function (t) {
            ...
            return (
                e && (i = " " + Y.target + "-" + e),
                this.generateClass(Y.target, t) + i
            );
        }),
        ...
        (l.prototype.classFocused = function (t) {
            return (
                " " +
                (0 <= this.focusedTargetIds.indexOf(t.id) ? Y.focused : "")
            );
        }),
        ...
        (l.prototype.getClipPath = function (t) {
            return (
                "url(" +
                (0 <=
                window.navigator.appVersion.toLowerCase().indexOf("msie 9.")
                    ? ""
        ...
        (l.prototype.getAxisClipHeight = function (t) {
            return (
                (t ? this.margin.bottom : this.margin.top + this.height) + 20
            );
        }),
                ...
                i.forEach(function (i) {
                    ...
                    c.isCustomX() || c.isTimeSeries()
                        ? 0 <= r.indexOf(e)
                            ...
                            : C(d.data_xs) &&
                              (c.data.xs[i] = c.getXValuesOfXKey(
                                  e,
                                  c.data.targets
                              ))
        ...
        (l.prototype.isOrderDesc = function () {
            var t = this.config;
            return (
                "string" == typeof t.data_order &&
                "desc" === t.data_order.toLowerCase()
            );
        }),
        ...
        (l.prototype.load = function (i, n) {
            ...
            i &&
                ...
                (n.type || n.types) &&
                    i.forEach(function (t) {
                        var e =
                            n.types && n.types[t.id] ? n.types[t.id] : n.type;
        ...
        (l.prototype.loadFromArgs = function (e) {
            ...
            e.data
                ...
                : e.json
                ? i.load(
                      i.convertDataToTargets(
                          i.convertJsonToData(e.json, e.keys)
                      ),
                      e
                  )
                : e.rows
                ...
                : e.columns
                ? i.load(
                      i.convertDataToTargets(i.convertColumnsToData(e.columns)),
                      e
                  )
                : i.load(null, e);
        }),
                              ...
                              i.legend &&
                                  i.legend
                                      .selectAll(
                                          "." +
                                              Y.legendItem +
                                              i.getTargetSelectorSuffix(e)
                                      )
                                      .remove(),
                              (i.data.targets = i.data.targets.filter(function (
                                  t
                              ) {
                                  return t.id !== e;
                              }));
            ...
            return (
                ...
                0 === _.length
                    ...
                    : (isNaN(m) && (m = 0),
                      ...
                      void 0 !== w &&
                          ((S = w + (s = Math.max(Math.abs(m), Math.abs(S)))),
                          (m = w - s)),
                      T
        ...
        (l.prototype.getXDomainPadding = function (t) {
            ...
            return (
                ...
                "object" === s(a.axis_x_padding) && C(a.axis_x_padding)
                    ? ((n = P(a.axis_x_padding.left)
                          ? a.axis_x_padding.left
                          : i),
                      (r = P(a.axis_x_padding.right)
                          ? a.axis_x_padding.right
                          : i))
                    : (n = r =
                          "number" == typeof a.axis_x_padding
                              ? a.axis_x_padding
                              : i),
                { left: n, right: r }
            );
                ...
                n - r != 0 ||
                    ...
                    (r = e.isTimeSeries()
                        ? ((n = new Date(0.5 * n.getTime())),
                          new Date(1.5 * r.getTime()))
                        : ((n = 0 === n ? 1 : 0.5 * n),
                          0 === r ? -1 : 1.5 * r)),
                (n || 0 === n) &&
                    (o = e.isTimeSeries()
                        ? new Date(n.getTime() - a.left)
                        : n - a.left),
                (r || 0 === r) &&
                    (s = e.isTimeSeries()
                ...
                e.zoom_enabled &&
                    ...
                    e.zoom_initialRange &&
                        t.eventRect
                            ...
                            .call(
                                t.zoom.transform,
                                t.zoomTransform(e.zoom_initialRange)
                            ));
        }),
        ...
        (l.prototype.getLegendHeight = function () {
            ...
            return (
                t.config.legend_show &&
                    (e = t.isLegendRight
                        ? t.currentHeight
                        : Math.max(20, t.legendItemHeight) *
                          (t.legendStep + 1)),
                e
            );
        }),
            ...
            (e = i.mapToTargetIds(e)),
                i.legend
                    ...
                    .style("opacity", function () {
                        return (
                            t ? i.opacityForLegend : i.opacityForUnfocusedLegend
                        ).call(i, i.d3.select(this));
                    });
        }),
        ...
        (l.prototype.getScale = function (t, e, i) {
            return (i ? this.d3.scaleTime() : this.d3.scaleLinear()).range([
                t,
                e,
            ]);
        }),
        ...
        (l.prototype.updateScales = function () {
            ...
            (e.xMin = t.axis_rotated ? 1 : 0),
                ...
                (e.y = e.getY(
                    e.yMin,
                    e.yMax,
                    i ? t.axis_y_default : e.y.domain()
                )),
                (e.y2 = e.getY(
                    e.yMin,
                    e.yMax,
                    i ? t.axis_y2_default : e.y2.domain()
                )),
            ...
            this.config.data_onunselected.call(this.api, e, t.node()),
                this.main
                    .select(
                        "." +
                            Y.selectedCircles +
                            this.getTargetSelectorSuffix(e.id)
                    )
                    .selectAll("." + Y.selectedCircle + "-" + i)
                    .transition()
                    .duration(100)
            ...
            a.data_selection_enabled &&
                ...
                (a.data_selection_multiple ||
                    n.main
                        ...
                        .each(function (t, e) {
                            var i = r.select(this);
                            i.classed(Y.SELECTED) &&
                                c(!1, i.classed(Y.SELECTED, !1), t, e);
                        }),
        ...
        (l.prototype.getBars = function (t, e) {
            return (
                e
                    ? this.main.selectAll(
                          "." + Y.bars + this.getTargetSelectorSuffix(e)
                      )
                    : this.main
        ...
        (l.prototype.expandBars = function (t, e, i) {
            i && this.unexpandBars(),
                this.getBars(t, e).classed(Y.EXPANDED, !0);
        }),
        ...
        (l.prototype.getShapeIndices = function (t) {
            ...
            return (
                this.filterTargetsToShow(
                    this.data.targets.filter(t, this)
                ).forEach(function (t) {
        ...
        (l.prototype.getShapeOffset = function (t, s, e) {
            var c = this,
                d = c.orderTargets(
                    c.filterTargetsToShow(c.data.targets.filter(t, c))
                ),
                l = d.map(function (t) {
                    return t.id;
                });
        ...
        (l.prototype.generateDrawLine = function (t, o) {
            ...
            return (
                ...
                function (t) {
                    var e = c.line_connectNull
                            ? s.filterRemoveNull(t.values)
                            : t.values,
                        i = o ? s.subX : s.x,
                        n = l.call(s, t.id),
                        r = 0,
                    ...
                    for (
                        a = f.getScale(
                            ...
                            h =
                                ...
                                (u =
                                    2 /
                                    Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))),
                            n = u;
                        n <= 1;
                        n += h
                    )
        ...
        (l.prototype.generateDrawArea = function (t, e) {
            ...
            return (
                ...
                function (t) {
                    var e = a.line_connectNull
                            ? r.filterRemoveNull(t.values)
                            : t.values,
                        i = 0,
                        n = 0;
                    return (
                        (r.isAreaType(t)
                            ? (r.isStepType(t) &&
                                  (e = r.convertValuesToStep(e)),
                              o.curve(r.getInterpolate(t))(e))
                            : (e[0] &&
                                  ((i = r.x(e[0].x)),
                                  (n = r.getYScale(t.id)(e[0].value))),
                              a.axis_rotated
                                  ? "M " + n + " " + i
                                  : "M " + i + " " + n)) || "M 0 0"
                    );
                ...
                ? "x" === t && i.axis_x_height
                    ...
                    ? "y2" !== t || i.axis_y2_show
                        ? ("x" === t &&
                          ...
                          n +
                              (e.axis.getLabelPositionById(t).isInner
                                  ? 0
                                  : 10) +
                              ("y2" === t ? -10 : 0))
        ...
        (l.prototype.initSubchart = function () {
            ...
            i.style("visibility", n),
                ...
                (t.axes.subx = i
                    ...
                    .attr(
                        "clip-path",
                        e.axis_rotated ? "" : t.clipPathForXAxis
                    ));
        }),
        ...
        (l.prototype.redrawSubchart = function (t, e, i, n, r, a, o) {
            ...
            l.context.style(
                "visibility",
                h.subchart_show ? "visible" : "hidden"
            ),
                h.subchart_show &&
                    (u.event &&
                        "zoom" === u.event.type &&
        ...
        (l.prototype.getDefaultSelection = function () {
            ...
            return (
                t.isTimeSeries() &&
                    (i = [t.parseDate(i[0]), t.parseDate(i[1])]),
                i
            );
        }),
        ...
        (l.prototype.redrawText = function (t, e, i, n, r) {
            return [
                (n ? this.mainText.transition(r) : this.mainText)
                    ...
                    .style(
                        "fill-opacity",
                        i ? 0 : this.opacityForText.bind(this)
                    ),
            ];
        }),
        ...
        (l.prototype.redrawTitle = function () {
            var t = this;
            t.title
                .attr("x", t.xForTitle.bind(t))
                .attr("y", t.yForTitle.bind(t));
        }),
        ...
        (l.prototype.tooltipPosition = function (t, e, i, n) {
            ...
            return (
                h
                    ? ((a =
                          (d.width -
                              (d.isLegendRight ? d.getLegendWidth() : 0)) /
                              2 +
                          g[0]),
                      (s =
                          (d.hasType("gauge") ? d.height : d.height / 2) +
                          g[1] +
                          20))
                    : ((r = d.getSvgLeft(!0)),
                      (s = l.axis_rotated
                          ...
                          : ((o =
                                (a =
                                    r +
                                    d.getCurrentPaddingLeft(!0) +
                                    d.x(t[0].x) +
                                    20) + e),
                            (c =
                                r +
                                d.currentWidth -
                                d.getCurrentPaddingRight()),
                            g[1] + 15)),
                      c < o && (a -= o - c + 20),
        ...
        (l.prototype.isStepType = function (t) {
            var e = c(t) ? t : t.id;
            return (
                0 <= ["step", "area-step"].indexOf(this.config.data_types[e])
            );
        }),
        (l.prototype.isSplineType = function (t) {
            ...
            return (
                0 <=
                ["spline", "area-spline"].indexOf(this.config.data_types[e])
            );
        }),
        ...
        (l.prototype.isArcType = function (t) {
            return (
                this.isPieType(t) || this.isDonutType(t) || this.isGaugeType(t)
            );
        }),
                ...
                (i.zoom = n
                    ...
                    .on("zoom", function () {
                        if ("scroll" === r.zoom_type) {
                            ...
                            (t && "brush" === t.type) ||
                                (i.redrawForZoom(),
                                r.zoom_onzoom.call(i.api, i.x.orgDomain()));
                        }
                    })
                    .on("end", function () {
                        if ("scroll" === r.zoom_type) {
                ...
                (i.zoom.updateDomain = function () {
                    return (
                        n.event &&
                            n.event.transform &&
                            i.x.domain(
                                n.event.transform.rescaleX(i.subX).domain()
                            ),
                        this
                    );
                }),
