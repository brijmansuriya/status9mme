...
!(function (t, e) {
    ...
    var E = {
            ...
            _parseFont: function (t) {
                ...
                return (
                    (i.string = (function (t) {
                        return !t ||
                            D.isNullOrUndef(t.size) ||
                            D.isNullOrUndef(t.family)
                            ? null
                            : (t.style ? t.style + " " : "") +
                                  (t.weight ? t.weight + " " : "") +
                                  t.size +
    ...
    B.extend($.prototype, {
        ...
        pivot: function () {
            var t = this;
            return (
                t._view || (t._view = B.extend({}, t._model)),
                (t._start = {}),
                t
            );
        },
        ...
        _resolveDataElementOptions: function (t, e) {
            ...
            if (((i = i || {}), B.isArray(c)))
                for (o = 0, s = c.length; o < s; ++o)
                    f[(l = c[o])] = tt([i[l], d[l], h[l]], g, e, m);
            else
                for (o = 0, s = (r = Object.keys(c)).length; o < s; ++o)
                    f[(l = r[o])] = tt([i[l], d[c[l]], d[l], h[l]], g, e, m);
    ...
    var At = at.extend({
            ...
            _resolveDataElementOptions: function () {
                var t = this,
                    e = B.extend(
                        {},
                        at.prototype._resolveDataElementOptions.apply(
                            t,
                            arguments
                        )
                    ),
    ...
    var Lt = at.extend({
            ...
            _resolveDataElementOptions: function (t, e) {
                var n = this,
                    ...
                    r = t.custom || {},
                    o = a.data[e] || {},
                    s = at.prototype._resolveDataElementOptions.apply(
                        n,
                        arguments
                    ),
                    l = {
            ...
            callbacks: {
                ...
                label: function (t, e) {
                    var n = e.labels[t.index],
                        i = ": " + e.datasets[t.datasetIndex].data[t.index];
                    return (
                        B.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n
                    );
                },
            },
        },
    ...
    Y._set("line", {
        ...
        hover: { mode: "label" },
        scales: {
            xAxes: [{ type: "categorie", id: "x-axis-0" }],
    ...
    var Jt = at.extend({
        ...
        _resolveDatasetElementOptions: function () {
            var t = this,
                e = t._config,
                n = t.chart.options,
                i = at.prototype._resolveDatasetElementOptions.apply(
                    t,
                    arguments
                );
            return (
    ...
    function Ee(t, e) {
        return (
            e && (B.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
        );
    }
    function Ve(t) {
    ...
    var Ue = X.extend({
            ...
            getTitle: function () {
                var t = this,
                    ...
                    o = [];
                return (
                    (o = Ee(o, Ve(i))), (o = Ee(o, Ve(a))), (o = Ee(o, Ve(r)))
                );
            },
            ...
            getFooter: function () {
                var t = this,
                    ...
                    r = [];
                return (
                    (r = Ee(r, Ve(n))), (r = Ee(r, Ve(i))), (r = Ee(r, Ve(a)))
                );
            },
            update: function (t) {
                var e,
            ...
            drawBody: function (t, e, n) {
                var i,
                    ...
                    y = function (e) {
                        n.fillText(e, b.x(t.x + p), t.y + h / 2),
                            (t.y += h + c);
                    },
                    x = b.textAlign(f);
                for (
    ...
    B.extend(en.prototype, {
        ...
        updateDataset: function (t) {
            ...
            !1 !== Re.notify(this, "beforeDatasetUpdate", [n]) &&
                ...
                Re.notify(this, "afterDatasetUpdate", [n]));
        },
        render: function (t) {
            var e = this;
            (t && "object" == typeof t) ||
        ...
        drawDataset: function (t, e) {
            ...
            !1 !== Re.notify(this, "beforeDatasetDraw", [n]) &&
                (t.controller.draw(e),
                Re.notify(this, "afterDatasetDraw", [n]));
        },
                ...
                if (ln(s))
                    for (r = 0, o = s.length; r < o; ++r)
                        (g = s[r]),
                            un(g) ||
                                ln(g) ||
                                ((c = B.measureText(t, d.data, d.gc, c, g)),
                                (f += h));
    ...
    var xn = X.extend({
        ...
        afterBuildTicks: function (t) {
            ...
            return ln(t) && t.length
                ...
                : ((e.ticks =
                      B.callback(e.options.afterBuildTicks, [e, e.ticks]) ||
                      e.ticks),
                  t);
        },
            ...
            if (
                ...
                if (u) {
                    ...
                    b
                        ...
                        (t.paddingLeft =
                            Math.max(((k - S) * t.width) / (t.width - S), 0) +
                            3),
                        (t.paddingRight =
                            Math.max(((M - D) * t.width) / (t.width - D), 0) +
                            3);
                } else {
        ...
        _autoSkip: function (t) {
            ...
            if (
                ((i = (function (t, e, n, i) {
                    ...
                    for (
                        o = 0, s = (a = B.math._factorize(l)).length - 1;
                        o < s;
                        o++
                    )
                        if ((r = a[o]) > u) return r;
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function (t, e) {
                        ...
                        (r = Math.ceil(g / m) - Math.floor(f / m)) > u &&
                            ...
                            s &&
                                (!Dn(d) &&
                                    B.almostWhole(d / m, m / 1e3) &&
                                    (i = d),
                                !Dn(h) &&
                                    B.almostWhole(h / m, m / 1e3) &&
                                    (a = h)),
                            (r = (a - i) / m),
    ...
    var Rn = {
        position: "left",
        ticks: { callback: sn.formatters.logarithmic },
    };
    function Nn(t, e) {
    ...
    var Wn = _n.extend({
            determineDataLimits: function () {
                ...
                (o.min = B.isFinite(o.min) ? o.min : null),
                    ...
                    (o.minNotZero = B.isFinite(o.minNotZero)
                        ? o.minNotZero
                        : null),
                ...
                (t.min = Nn(e.min, t.min)),
                    ...
                    t.min === t.max &&
                        (0 !== t.min && null !== t.min
                            ? ((t.min = Math.pow(
                                  10,
                                  Math.floor(Ln(t.min)) - 1
                              )),
                              (t.max = Math.pow(10, Math.floor(Ln(t.max)) + 1)))
                            : ((t.min = 1), (t.max = 10))),
                    null === t.min &&
                        (t.min = Math.pow(10, Math.floor(Ln(t.max)) - 1)),
                    null === t.max &&
                        (t.max =
                            0 !== t.min
                                ? Math.pow(10, Math.floor(Ln(t.min)) + 1)
                                : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
            ...
            getPixelForValue: function (t) {
                ...
                return (
                    (t = +e.getRightValue(t)) > e.min &&
                        t > 0 &&
                        (n =
                            (Ln(t) - e._startValue) / e._valueRange +
                            e._valueOffset),
                ...
                return (
                    ...
                    (i._majorUnit =
                        s.major.enabled && "year" !== i._unit
                            ? (function (t) {
                                  for (
                                      var e = ii.indexOf(t) + 1, n = ii.length;
                                      e < n;
                                      ++e
                                  )
        ...
        mi = e(function (e, n) {
            e.exports = (function () {
                ...
                function p(t) {
                    var e = f(NaN);
                    return (
                        null != t ? c(g(e), t) : (g(e).userInvalidated = !0), e
                    );
                }
                ...
                function me(t, e) {
                    if (null !== e) {
                        ...
                        if (((e.abbr = t), null != de[t]))
                            ...
                            if (null != de[e.parentLocale])
                                i = de[e.parentLocale]._config;
                            else {
                                if (null == (n = fe(e.parentLocale)))
                                    return (
                                        he[e.parentLocale] ||
                                            (he[e.parentLocale] = []),
                                        he[e.parentLocale].push({
                                            name: t,
                                            config: e,
                                        }),
                                        null
                ...
                function Ue(t, e) {
                    ...
                    return e._isUTC
                        ? ((n = e.clone()),
                          (i =
                              (_(t) || u(t) ? t.valueOf() : Le(t).valueOf()) -
                              n.valueOf()),
                ...
                (Mn.add = en),
                    (Mn.calendar = function (t, e) {
                        ...
                        return this.format(
                            o || this.localeData().calendar(r, this, Le(n))
                        );
                    }),
                    (Mn.clone = function () {
                        return new x(this);
                    ...
                    (Mn.endOf = function (t) {
                        ...
                        return (
                            this._d.setTime(e), a.updateOffset(this, !0), this
                        );
                    }),
                    ...
                    (Dn.monthsParse = function (t, e, n) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                n &&
                                    "MMMM" === e &&
                                    this._longMonthsParse[i].test(t))
                            )
                                return i;
                            if (
                                n &&
                                "MMM" === e &&
                                this._shortMonthsParse[i].test(t)
                            )
                                return i;
                    ...
                    (Dn.weekdaysParse = function (t, e, n) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                n &&
                                    "dddd" === e &&
                                    this._fullWeekdaysParse[i].test(t))
                            )
                                return i;
                            if (
                                n &&
                                "ddd" === e &&
                                this._shortWeekdaysParse[i].test(t)
                            )
                                return i;
                            if (
                                n &&
                                "dd" === e &&
                                this._minWeekdaysParse[i].test(t)
                            )
                                return i;
                ...
                return (
                    ...
                    (ri.as = function (t) {
                        ...
                        if (
                            ...
                            switch (
                                ((e =
                                    this._days + Math.round(Ln(this._months))),
                                t)
                            ) {
                                case "week":
                                    return e / 7 + i / 6048e5;
                    ...
                    (ri.get = function (t) {
                        return (
                            (t = R(t)), this.isValid() ? this[t + "s"]() : NaN
                        );
                    }),
                    (ri.milliseconds = Gn),
                    (ri.seconds = qn),
                    ...
                    (ri.humanize = function (t) {
                        ...
                        return (
                            t && (n = e.pastFuture(+this, n)), e.postformat(n)
                        );
                    }),
                    (ri.toISOString = ai),
                    (ri.toString = ai),
    ...
    function ki(t, e, n, i, a) {
        ...
        if (i && a) {
            for (t.moveTo(e[0].x, e[0].y), r = 1; r < i; ++r)
                B.canvas.lineTo(t, e[r - 1], e[r]);
            if (void 0 === n[0].angle)
                for (t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1; r > 0; --r)
                    B.canvas.lineTo(t, n[r], n[r - 1], !0);
            else
                for (
                    o = n[0].cx,
                        s = n[0].cy,
                ...
                if (((a.font = r.string), u)) {
                    ...
                    (a.textAlign = "left"),
                        ...
                        B.each(t.legendItems, function (t, e) {
                            var i =
                                Ti(n, o) + o / 2 + a.measureText(t.text).width;
                            (0 === e ||
                    ...
                    !(function (t, e, i) {
                        if (!(isNaN(p) || p <= 0)) {
                            ...
                            if (
                                ...
                                c.setLineDash &&
                                    c.setLineDash(Pi(i.lineDash, r.borderDash)),
                                n && n.usePointStyle)
                            ) {
    ...
    function Ai(t, e) {
        var n = new Oi({ ctx: t.ctx, options: e, chart: t });
    ...
    function Ri(t, e) {
        var n = new Li({ ctx: t.ctx, options: e, chart: t });
    ...
    var Vi = nn;
    return (
        "undefined" != typeof window && (window.Chart = nn),
        (nn.Chart = nn),
