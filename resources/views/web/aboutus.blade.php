...
<div class="container marketing">
    ...
    <div class="row featurette">
      <div class="col-md-7">
        ...
        <p class="lead">If you have any query regrading Site, Advertisement and any other issue, please feel free to contact at <strong>news9mme@gmail.com</strong></p>
      </div>
      <div class="col-md-5">
        <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 400px;" src="web/img/about-us-statush9mme.jpg" data-holder-rendered="true">
      </div>
    </div>
    <hr class="featurette-divider">
    {{--
