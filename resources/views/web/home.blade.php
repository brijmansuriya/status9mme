        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                    ...
                    <a class="text-secondary font-weight-medium text-decoration-none" href="{{route('web.categorieslist')}}">View All</a>
                </div>
                @foreach ($categorys as $category)
                <div class="position-relative overflow-hidden mb-3" style="height: 80px;">

                    <a href="{{route('web.categories',[$category->slug])}}" class="overlay align-items-center justify-content-center h4 m-0 text-white text-decoration-none">{{$category->name}}</a>
                </div>
                @endforeach
            </div>
        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                ...
                                <a class="text-secondary font-weight-medium text-decoration-none" href="{{route('web.allpopularpostlist')}}">View All</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100 h-200" src="{{$popular->image}}" style="object-fit: cover;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <div >{{$popular->category->name ?? ''}}</div>
                                    </div>
                                    <div class="h4" >
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                ...
                                <a class="text-secondary font-weight-medium text-decoration-none" href="{{route('web.alllatestpostlist')}}">View All</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100 h-200" src="{{$latest->image}}" style="object-fit: cover;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <div >{{$latest->category->name ?? ''}}</div>
                                    </div>
                                    <div class="h4">
