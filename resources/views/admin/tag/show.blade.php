        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card d-block align-items-start">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            <h5 class="card-title font-16 "> tag Details</h5>
                        </div>
                        <div class="col-md-1">
                            <a href="{{ route('tag.edit', $tag->id) }}" class="btn btn-success mb-2">Edit</a>
                            {{-- <a href="{{ route('tag.delete', $tag->id) }}" class="btn btn-danger mb-2">Delete</a> --}}
                        </div>
                    </div>
