                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('tag.index') }}">Categorie</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('tag.update', $tag->id) }}" novalidate=""
                            ...
                            <div class="form-group" id="tag-name-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $tag->name }}"
                                    ...
                                    data-parsley-class-handler="#tag-name-group" data-parsley-minlength="2"
