            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Categorie List</li>
                    </ol>
                </div>
                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-lg-6">
                            <div class="text-lg-right">
                                <a type="button" id="delete_record" class="btn btn-primary waves-effect waves-light mb-2"
                                    href="javascript:void(0)">Delete All</a>
                                <a type="button" class="btn btn-primary waves-effect waves-light mb-2 mr-2"
                                    href="{{ route('categorie.create') }}">Add Categorie</a>
                            </div>
                        </div><!-- end col-->
                    </div>
                ...
                if (confirmdelete == true) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var dataTable = $('#categorie-table').DataTable();
                            dataTable.ajax.reload();
