                    ...
                    <div class="row mb-2 ">
                        ...
                        <div class="col-lg-6">
                            <div class="text-lg-right">
                                <a type="button" class="btn btn-default waves-effect waves-light mb-2 mr-2" href="{{ route('category.create') }}">Add Category</a>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/pages/category-data-table.js') }}"></script>
    <script>
