    ...
    <div style="padding:10px">
        <table style="width: 100%;">
            <tbody>
                ...
                <tr>
                    <td style="font-size: 24px;padding: 20px 0;text-align:center;"><span style="color: #6ca5b3;font-weight: 600;">Booth
                        </span><span style="color: #000000;"> #{{ $member->exhibitor->booth_number }}</span></td>
                </tr>
                <tr>
        ...
        <table style="width: 100%;margin: 30px 0;">
            <tbody>
                <tr>
                    <td style="font-size: 24px;width:300px;overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">
                        {{ ($member->title=='Other') ?$member->other_title :$member->title }}<br><span
                            style="font-weight: bold;">{{ $member->first_name . ' ' . $member->last_name }}</span>
                    </td>

                    <td style="text-align: right; width:120px;" rowspan="2">
                            <img src="{{ 'storage/qr_codes/exhibitor/' . $member->exhibitor->id . '.png' }}"
        ...
        <table style="width: 100%;background-color: #E8FFF0;padding: 25px;margin: 20px 0 0 0;">
            ...
            <tr>
                ...
                <td style="padding-bottom: 8px;">: {{ $member->email }}</td>
            </tr>
            <tr>
                <td style="color: #6ca5b3;font-weight: 700;padding-bottom: 8px;">Country</td>
                <td style="padding-bottom: 8px;">: {{ $member->exhibitor->country ? $member->exhibitor->country->name : '' }}</td>
            </tr>
            <tr>
                <td style="color: #6ca5b3;font-weight: 700;padding-bottom: 8px;">City</td>
                <td style="padding-bottom: 8px;">: {{ $member->exhibitor->city }}</td>
            </tr>
            <tr>
                <td style="color: #6ca5b3;font-weight: 700;padding-bottom: 8px;">Company Name</td>
                <td style="padding-bottom: 8px;">: {{ $member->exhibitor->company_name }}</td>
            </tr>
            {{-- <tr>
                <td style="color: #6ca5b3;font-weight: 700;padding-bottom: 8px;">Position</td>
                <td style="padding-bottom: 8px;">: {{ $member->exhibitor->position }}</td>
            </tr> --}}
        </table>
